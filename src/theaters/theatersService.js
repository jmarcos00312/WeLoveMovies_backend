...
const movieTheaterJoin = knex("theaters as t")
  .join("movies_theaters as mt", "t.theater_id", "mt.theater_id")
  .join("movies as m", "m.movie_id", "mt.movie_id");

const list = () =>
  movieTheaterJoin.select(
    "t.theater_id",
    "t.name",
    "t.address_line_1",
    "t.address_line_2",
    ...
    "mt.is_showing as movies_theaters:is_showing",
    "mt.theater_id as movies_theaters:theater_id"
  );
